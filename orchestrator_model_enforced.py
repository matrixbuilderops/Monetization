...
def main():
    ...
    print("== Unbreakable Project Orchestrator with Model-Enforced Output ==")
    ...
    while True:
        ...
        if user.startswith("write "):
            ...
            prompt = user
            code = run_mixtral(f"Write a complete Python script that does the following: {prompt} ONLY OUTPUT CODE.")
            if code:
