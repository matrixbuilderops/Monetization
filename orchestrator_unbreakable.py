...
# You can edit this at any time, or add a command to update it interactively
project_context = """
...
def run_mixtral(user_command):
    # Always inject context before the user command
    full_prompt = (
        f"{project_context}\n"
...
def main():
    ...
    print("== Unbreakable Project Orchestrator ==")
